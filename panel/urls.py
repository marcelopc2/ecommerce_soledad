...
urlpatterns = [
    ...
    path('correos/nuevo/', views.correo_form, name='correo_new'),
    path('correos/<int:pk>/', views.correo_detalle, name='correo_detalle'),
    path('correos/<int:pk>/editar/', views.correo_form, name='correo_edit'),
    path('correos/<int:pk>/vista-previa/', views.correo_vista_previa, name='correo_vista_previa'),
    path('correos/<int:pk>/prueba/', views.correo_prueba, name='correo_prueba'),
    ...
    path('cupones/<int:pk>/estado/', views.coupon_toggle_active, name='coupon_toggle_active'),
    path('cupones/<int:pk>/eliminar/', views.coupon_delete, name='coupon_delete'),
